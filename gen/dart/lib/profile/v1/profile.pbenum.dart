...
class RoleType extends $pb.ProtobufEnum {
  ...
  static const RoleType ROLE_TYPE_CUSTOMER = RoleType._(3, _omitEnumNames ? '' : 'ROLE_TYPE_CUSTOMER');
  static const RoleType ROLE_TYPE_EMPLOYEE = RoleType._(4, _omitEnumNames ? '' : 'ROLE_TYPE_EMPLOYEE');
