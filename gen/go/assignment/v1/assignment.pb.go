...
type AssignmentModel struct {
	...
	Project     *ProjectModel          `protobuf:"bytes,10,opt,name=project,proto3" json:"project,omitempty"`
}
...
func (x *AssignmentModel) GetProject() *ProjectModel {
	if x != nil {
		return x.Project
	}
	return nil
...
var file_assignment_v1_assignment_proto_rawDesc = []byte{
	...
	0x76, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x3b, 0x70,
...
var file_assignment_v1_assignment_proto_goTypes = []interface{}{
	...
	(*ProjectModel)(nil),           // 4: project.v1.ProjectModel
}
