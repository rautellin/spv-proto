...
type ProjectModel struct {
	...
	Organization *OrganizationModel     `protobuf:"bytes,11,opt,name=organization,proto3" json:"organization,omitempty"`
}
...
func (x *ProjectModel) GetOrganization() *OrganizationModel {
	if x != nil {
...
var file_project_v1_project_proto_rawDesc = []byte{
	...
	0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x6c, 0x69, 0x74, 0x74, 0x72, 0x61, 0x5f, 0x69, 0x64, 0x42, 0x2d,
	0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x61, 0x75,
...
var file_project_v1_project_proto_goTypes = []interface{}{
	...
	(*OrganizationModel)(nil),     // 3: organization.v1.OrganizationModel
}
